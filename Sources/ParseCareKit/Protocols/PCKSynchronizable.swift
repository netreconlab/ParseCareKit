...
/**
 ...
 In order to synchronize objects, they must also conform to either `PCKObjectable` or `PCKVersionable`. For examples, see
 `Patient`, `CarePlan`, `Task`, `Contact`, and `Outcome`. Note that objects such as `OutcomeValue` and
