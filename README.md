...
This framework is an API to synchronize [CareKit](https://github.com/carekit-apple/CareKit) 2.0+ data with [parse-server](https://github.com/parse-community/parse-server). Note that CareKit data is extremely sensitive and you are responsible for ensuring your parse-server meets HIPAA compliance. You can use [parse-postgres](https://github.com/netreconlab/parse-postgres) to setup a HIPAA compliant Parse/[Postgres](https://www.postgresql.org) backend along with [Parse Dashboard](https://github.com/parse-community/parse-dashboard). If you preffer mongo, you can swap out the db with [hipaa_mongo](https://github.com/netreconlab/hipaa_mongodb).

## CareKit Sample App with ParseCareKit
A sample app, [CareKitSample-ParseCareKit](https://github.com/netreconlab/CareKitSample-ParseCareKit), connects to the aforementioned [parse-postgres](https://github.com/netreconlab/parse-postgres) and demonstrates how CareKit data can be easily synched to the Cloud using ParseCareKit.
